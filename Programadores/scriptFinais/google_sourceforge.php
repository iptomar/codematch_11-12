...
function get_google_sourceforge() {
    ...
    curl_setopt($ch, CURLOPT_URL, 'https://www.googleapis.com/customsearch/v1?key=AIzaSyC3tu4QLO-rePWJqTDb6CEBqxnHIAznUAE&amp&cx=009295779571442939711:7xtebgwnjiw&q=*&alt=json');  //faz a pesquisa contida no url
