...
/*INPUTS:
proj_name - nome do projecto <string> LOWERCASE
desc - descricao do projecto <string>
...
lang - linguagens do projecto <array -string> UPPERCASE
author - autor/es do projecto <array -string> LOWERCASE
*/
...
//*****Insert data
//project details DB
$column_detail -> insert($proj_name, array(CassandraUtil::uuid1() => array('descric' => $desc,'source' => $source, 'date_c' => $data_c, 'date_l' => $data_lst, 'logo' => $logo)));
...
$column_presence -> insert($proj_name, array('repo_S' => "Sourceforge",'repo_G' =>'null', 'repo_L' => 'null'));
}

if($repos == "Github"){
$column_presence -> insert($proj_name, array('repo_G' => "Github",'repo_S' =>'null', 'repo_L' => 'null'));
}

if($repos == "Launchpad"){
$column_presence -> insert($proj_name, array('repo_L' => "Launchpad",'repo_G' =>'null', 'repo_S' => 'null'));
}
