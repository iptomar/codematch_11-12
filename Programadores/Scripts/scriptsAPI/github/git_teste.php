<?php
	print_r("Apresentar repositorios de 'ruby' + 'testing' <br><br>");
	//pagina do api
	...
	foreach($jsonobj->repositories as $arg) { //para cada repositório encontrado na pesquisa:
		...
		print_r("<b>Descricao: </b>".$arg->description."<br>"); //imprime a descricao do projecto
		print_r("<b>Seguidores: </b>".$arg->followers." - <b>Watchers: </b>".$arg->watchers." - <b>Criado a: </b>".$arg->created_at."<br>"); //imprime o numero de seguidores e de watchers.
		print_r("<br><br>");
	}	
?>